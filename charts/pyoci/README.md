...
![Version: 1.1.0](https://img.shields.io/badge/Version-1.1.0-informational?style=flat) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat) ![AppVersion: v0.1.38](https://img.shields.io/badge/AppVersion-v0.1.38-informational?style=flat)
...
| image.tag | string | `"v0.1.38"` | Tag for the image. |
