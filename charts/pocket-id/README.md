...
![Version: 1.5.6](https://img.shields.io/badge/Version-1.5.6-informational?style=flat) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat) ![AppVersion: v1.11.1](https://img.shields.io/badge/AppVersion-v1.11.1-informational?style=flat)
...
| pocketID.image.tag | string | `"v1.11.1"` | Tag for the image. |
