...
![Version: 2.2.1](https://img.shields.io/badge/Version-2.2.1-informational?style=flat) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat) ![AppVersion: v2.11.0](https://img.shields.io/badge/AppVersion-v2.11.0-informational?style=flat)
...
helm install pocket-id anza-labs/pocket-id --version 2.2.1
```
...
| backup.image.tag | string | `"0.5.15"` | Tag for the image. |
...
| pocketID.image.tag | string | `"v2.11.0"` | Tag for the image. |
