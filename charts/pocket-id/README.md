...
![Version: 2.2.2](https://img.shields.io/badge/Version-2.2.2-informational?style=flat) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat) ![AppVersion: v2.14.0](https://img.shields.io/badge/AppVersion-v2.14.0-informational?style=flat)
...
helm install pocket-id anza-labs/pocket-id --version 2.2.2
```
...
| pocketID.image.tag | string | `"v2.14.0"` | Tag for the image. |
