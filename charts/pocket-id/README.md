...
![Version: 1.6.0](https://img.shields.io/badge/Version-1.6.0-informational?style=flat) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat) ![AppVersion: v1.11.2](https://img.shields.io/badge/AppVersion-v1.11.2-informational?style=flat)
...
| pocketID.image.tag | string | `"v1.11.2"` | Tag for the image. |
