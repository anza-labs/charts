...
![Version: 1.5.5](https://img.shields.io/badge/Version-1.5.5-informational?style=flat) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat) ![AppVersion: v1.10.0](https://img.shields.io/badge/AppVersion-v1.10.0-informational?style=flat)
...
| pocketID.image.tag | string | `"v1.10.0"` | Tag for the image. |
